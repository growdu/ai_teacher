...
public interface CourseMapper extends BaseMapper<Course> {
    ...
    @Select("SELECT id, tenant_id, workspace_id, knowledge_point_id, title, outline, script, status, creator_id, created_at, updated_at, deleted FROM course WHERE id = #{id} AND deleted = false")
    Course selectByIdCustom(Long id);
}